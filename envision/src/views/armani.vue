    ...
    export default {
        data() {
            return {
                datasAll:[],
                imgdata: [
                    {id: 0, idView: require("../assets/images/armani/armani-banner1.jpg")},
                    {id: 1, idView: require("../assets/images/armani/armani-banner2.jpg")},
                    {id: 2, idView: require("../assets/images/armani/armani-banner3.jpg")},
                    {id: 3, idView: require("../assets/images/armani/armani-banner4.jpg")},
                    {id: 4, idView: require("../assets/images/armani/armani-banner5.jpg")},
                    {id: 5, idView: require("../assets/images/armani/armani-banner6.jpg")}
                ],
                url:'',
                dataTils: [
                    {
