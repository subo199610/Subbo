        ...
        <el-table
            ...
            >
                <template slot-scope="scope">
                    <el-button type="success" @click="linkk(scope.row.orders_id)"  v-if="scope.row.orders_sestate=='1'">退款</el-button>

                    <el-button  type="primary" @click="link(scope.row.orders_id)"  v-if="scope.row.orders_sestate!='1'">详情</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--分页-->
