        ...
        <ul class="orders-main" v-for="(good,index) in order.list" :key="index">
            ...
            <div class="orders-operate">
                <div >
                    ...
                    <div class="orders-btn btn-blue sure_orders" v-if="index==0&&good.is_refund==0" @click="takeOrder(order.ordersId)">确认收货</div>
...
<script>
    export default {
        ...
        created(){
            console.log('chakanzhuangtai:',this.order.ordersState);
            switch (this.order.ordersState){
                case 0 : this.ordersState= '待付款';break;
                case 1 : this.ordersState= '待发货';break;
                case 2 : this.ordersState= '待收货';break;
                case 3 : this.ordersState= '待评价';break;
                case 4 : this.ordersState= '已评价';break;
                case 5 : this.ordersState= '已取消';break;
            }
        },
        mounted() {
          console.log('mounted')
