        ...
        <ul class="orders-main" v-for="(good,index) in order.list" :key="index">
            ...
            <div class="orders-operate">
                <div>
                    ...
                    <div class="orders-btn btn-blue"  v-if="good.is_refund==0&&good.is_eval==0"><router-link :to="{name:'comment',params:{ordersId:order.ordersId,goodsId:good.goods_id,attrId:good.attr_id}}">去评价</router-link></div>
                    <div style="text-align: center;margin-bottom: 5px" v-show="good.is_eval!=0">已评价</div>
