        ...
        <el-table
            ...
            >
                <template slot-scope="scope">
                    <div class="btn" v-if="scope.row.ordersState!='退款中'">
                    <el-button type="primary" @click="link(scope.row.ordersId)" >
                        <div>详情
                        </div>
                    </el-button>
                    </div>
                    ...
                    <div class="btn" v-if="scope.row.ordersState=='退款中'" @click="centerDialogVisible = true;id=scope.row.ordersId">
